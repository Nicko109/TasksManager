...
export default {
    ...
    methods: {
        ...
        store() {
            ...
            this.file.append('deadline', this.deadline);
            this.file.append('performer_id', this.performerId);
            this.file.append('project_id', this.projectId);
            router.post('/tasks', this.file)
        }
    }
}
